...
class CyclicGroup(Group, metaclass=CachedGroupMeta):
    ...
    def subgroup(self, m: int) -> GroupHomomorphism:
        """
        All subgroups of Cn are cyclic and are indexed by factors of n. The subgroup of order m is generated by r^(n/m).
        Args:
            m: the order of the subgroup (must divide n)
        Returns: 
            a GroupHomomorphism representing the inclusion of the subgroup into Cn 
        """
