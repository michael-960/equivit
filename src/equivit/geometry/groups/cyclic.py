...
class CyclicGroup(Group, metaclass=CachedGroupMeta):
    ...
    The elements of the group are represented as words in the generator :math:`r` (rotation).
    ...
    def subgroup(self, m: int) -> GroupHomomorphism:
        r"""
        All subgroups of :math:`C_n` are cyclic and are indexed by factors of :math:`n`. The subgroup of order :math:`m` is generated by :math:`r^{n/m}`.

        Args:
            m: the order of the subgroup (must divide :math:`n`)

        Returns: 
            a GroupHomomorphism representing the inclusion of the subgroup into :math:`C_n`
        """
